...
Public Class ApplicationUserManager
    ...
    Public Shared Function Create(options As IdentityFactoryOptions(Of ApplicationUserManager), context As IOwinContext) As ApplicationUserManager
        ...
        Dim manager As New ApplicationUserManager(New UserStore(Of ApplicationUser)(context.Get(Of ApplicationDbContext)()))
        ...
        Dim passValidator As New PasswordValidator()
        With passValidator
            .RequiredLength = 6
        ...
        manager.PasswordValidator = passValidator
